  ...
  if (medicines.length === 0) {
    return (
      <Card className="mt-4 shadow">
        <CardHeader>
           <CardTitle className="font-headline flex items-center"><PackageOpen className="mr-2 h-6 w-6 text-primary" />Empty Inventory</CardTitle>
           <CardDescription>No medicines found in your inventory. Start by adding some!</CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <div className="text-center">
            <Button asChild>
              <Link href="/inventory/add">Add Your First Medicine</Link>
            </Button>
          </div>
        </CardContent>
      </Card>
  ...
  return (
    <Card className="shadow-lg">
       <CardHeader>
        ...
        <CardDescription>Overview of all medicines currently in stock.</CardDescription>
      </CardHeader>
      <CardContent>
