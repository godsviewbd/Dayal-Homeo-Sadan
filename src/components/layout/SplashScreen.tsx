  ...
  return (
    <div
      ...
      className={cn(
        ...
        "bg-gradient-to-b from-[#E5F2F0] to-[#F9FAFB]", // Light mode gradient from spec
        "dark:from-[#1F2A37] dark:to-[#111827]", // Dark mode gradient
        "cursor-pointer" // Make it clear it's skippable
      )}
      onClick={onSkip}
    >
      ...
      <div
        className={cn(
          ...
          "bg-white/20 dark:bg-gray-800/30", // Semi-transparent background
          "backdrop-blur-md rounded-3xl", // Frosted glass effect
          "opacity-0" // Initial state for animation, animation class handles fade-in
        )}
      />
      ...
      <p
        className={cn(
          ...
          "text-teal-600/80 dark:text-teal-400/80",
           "opacity-0 motion-safe:animate-fadeInSlow motion-safe:[animation-delay:0.9s]"
        )}
      >
